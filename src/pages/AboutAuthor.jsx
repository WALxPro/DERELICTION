...
const TIMELINE_ITEMS = [
  { label: '01', title: 'Childhood', text: 'Growing up between cultures, between Kingston, Trench Town and Miami.' },
  { label: '02', title: 'Military', text: 'A life shaped by duty, discipline and brotherhood under uniform.' },
  { label: '03', title: 'Transformation', text: 'Finding a new voice after everything familiar changed direction.' },
  { label: '04', title: 'Writing', text: 'Turning lived experience into cinematic, honest storytelling.' },
  { label: '05', title: 'Dereliction', text: 'Sharing the journey — duty, betrayal, and fighting back.' },
]

const UPCOMING = [
  'Pastors Kids Are The Worst',
  'Maritime',
  'Nelson Mandela',
  'The Jamaican',
  'Blue Testament',
    ...
    <div>
      ...
      <section className="hero" style={{ minHeight: '70vh' }}>
        ...
        <div className="hero-content">
          ...
          <ScrollReveal delay={100}><h1 className="hero-title" style={{ fontSize: 'clamp(1.5rem, 6vw, 4.2rem)' }}>ABOUT THE AUTHOR</h1></ScrollReveal>
      ...
      <section className="section darker">
        <div className="container grid-3 stagger">
          {[
            // { target: 5, suffix: '+', label: 'Upcoming Works' },
      ...
      {/* <section className="section darker">
        <div className="container section-intro">
          <ScrollReveal><h2 className="section-heading">Author <span className="gold">Timeline</span></h2></ScrollReveal>
        </div>
        <div className="container"><Timeline items={TIMELINE_ITEMS} /></div>
      </section> */}

      {/* UPCOMING WORKS */}
      {/* <section className="section dark">
        <div className="container section-intro">
          <ScrollReveal><h2 className="section-heading">Coming <span className="gold">Next</span></h2></ScrollReveal>
        </div>
        <div className="container grid-3 stagger">
          {UPCOMING.map((title, i) => (
            <ScrollReveal key={title} delay={i * 90}>
              <div className="info-card gold-card" style={{ position: 'relative' }}>
                <span className="pill" style={{ position: 'absolute', top: 18, right: 18 }}>Coming Soon</span>
      ...
      <section className="section darker">
        <div className="container" style={{ textAlign: 'center' }}>
          <ScrollReveal><h2 className="section-heading">Follow The <span className="gold">Journey</span></h2></ScrollReveal>
